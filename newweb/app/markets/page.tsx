...
export default function MarketsPage() {
  ...
  const sortedMarkets = [...filteredMarkets].sort((a, b) => {
    ...
    switch (sortBy) {
      ...
      case "supplyApy":
        comparison =
          Number.parseFloat(a.supplyApy.replace(/[^0-9.-]+/g, "")) -
          Number.parseFloat(b.supplyApy.replace(/[^0-9.-]+/g, ""))
        break
      case "borrowApr":
        comparison =
              ...
              <thead>
                <tr className="border-b border-slate-800">
                  ...
                  <th className="text-right p-4">
                    ...
                    >
                      Supply APY
                      {sortBy === "supplyApy" && <ArrowUpDown className="h-4 w-4" />}
                    </button>
                  </th>
                  <th className="text-right p-4">
                    <button
              ...
              <tbody>
                {sortedMarkets.map((market) => (
                  <tr key={market.symbol} className="border-b border-slate-800 hover:bg-slate-900/50">
                    ...
                    <td className="p-4 text-right text-primary font-medium">{market.supplyApy}</td>
      ...
      <div className="mt-12 grid md:grid-cols-2 gap-8">
        ...
        <Card className="web3-card">
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-slate-800/50 rounded-lg">
                <span className="text-slate-400">Highest Supply APY</span>
