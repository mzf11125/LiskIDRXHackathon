...
export default function LendingOpportunityPage({
  ...
  const calculateReturns = () => {
    ...
    const rate =
      Number.parseFloat(opportunity?.expected_return.replace("%", "") || "0") /
      100;
  ...
  const handleLendSubmit = () => {
    ...
    const minAmount = Number.parseFloat(
      opportunity?.minimum_investment.split(" ")[0].replace(/,/g, "") || "0"
    );
    const maxAmount = Number.parseFloat(
      opportunity?.maximum_investment.split(" ")[0].replace(/,/g, "") || "0"
    );
  ...
  if (!isConnected) {
    return (
      <div className="container mx-auto px-4 py-16 text-center">
        ...
        <p className="text-slate-400 mb-8 max-w-md mx-auto">
          Please connect your wallet to view and interact with this lending
          opportunity.
        </p>
  ...
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="mb-8">
        ...
        >
          <ArrowLeft className="mr-2 h-4 w-4" /> Back to Business Proposals
        </Button>
      ...
      <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            <div className="flex items-end gap-2">
              ...
              <TooltipProvider>
                <Tooltip>
                  ...
                  <TooltipContent>
                    <p>Annual Percentage Yield (APR): {opportunity.apr}</p>
                  </TooltipContent>
                </Tooltip>
              </TooltipProvider>
            </div>
        ...
        <Card className="web3-card">
          <CardHeader className="pb-2">
            <CardTitle className="text-lg">Total Funding Required</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="flex items-end gap-2">
              <p className="text-3xl font-bold gradient-text">
        ...
        <div className="md:col-span-2">
          ...
          >
            ...
            <TabsContent value="overview" className="space-y-6">
              <Card className="web3-card">
                <CardHeader>
                  <CardTitle>Business Proposal Overview</CardTitle>
                </CardHeader>
                <CardContent>
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                        <div className="bg-slate-800/50 p-4 rounded-lg">
                          ...
                          <p className="text-sm font-medium">
                            {formatDate(opportunity.proposed_at)}
                          </p>
                        </div>
                        <div className="bg-slate-800/50 p-4 rounded-lg">
                ...
                <CardContent>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {opportunity.documents?.map((doc: any) => (
                      <Card key={doc.id} className="bg-slate-800/50">
                        <CardHeader className="pb-2">
          ...
          <Card className="web3-card sticky top-24">
            ...
            <CardContent className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <div className="flex justify-between">
                  <p className="text-sm text-slate-400">Max Investment</p>
                  <p className="text-sm font-medium">
                    {opportunity.maximum_investment}
                  </p>
                </div>
