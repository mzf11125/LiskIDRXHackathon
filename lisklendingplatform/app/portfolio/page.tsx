                        ...
                        >
                          ...
                          <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                            <div>
                              ...
                              <p>
                                {investment.amount} {investment.token}
                              </p>
                            </div>
                            <div>
                            ...
                            <div>
                              ...
                              <p className="text-green-400">
                                {investment.earned} {investment.token}
                              </p>
                            </div>
                            <div>
            ...
            <TabsContent value="proposals">
              <Card className="web3-card">
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage your submitted business proposals
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {proposalsLoading ? (
                      ...
                      {myProposals.map((proposal: any) => (
                        ...
                        >
                          ...
                          <div className="flex justify-between text-xs">
                            <span>
                              Target: {proposal.target_funding}{" "}
                    ...
                    <div className="flex flex-col items-center justify-center py-12">
                      <p className="text-slate-400 text-center mb-4">
                        You haven't created any business proposals yet.
                      </p>
                      <Button
