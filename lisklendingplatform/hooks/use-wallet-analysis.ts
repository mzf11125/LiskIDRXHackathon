...
/**
 * This type represents the wallet analysis data needed by the frontend components.
 * It's a simpler version of the full AIWalletAnalysis type from the API.
 */
  ...
  const fetchWalletAnalysis = async (walletAddress: string) => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "Unable to retrieve wallet analysis. Please try again later.",
      });
